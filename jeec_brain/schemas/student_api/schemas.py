...
class StudentDetail(BaseModel):
    ...
    login_dates: Optional[List[datetime]] = Field(None, description="Student login dates")
    referral_code: Optional[str] = Field(None, description="Student referral code")

class StudentInfoList(BaseModel):
    list: Dict[str,List[StudentDetail]] = Field(None, description="Student information list")
...
class LevelDetailList(BaseModel):
    list: Optional[Dict[str,List[LevelDetail]]] = Field(None, description="Student information list")
...
class SquadDetail(BaseModel):
    ...
    members: Dict[str,List[SquadMembersDetail]] = Field(None, description="Squad members list")
...
class SquadInvitationsSentList(BaseModel):
    list: Dict[str,List[SquadInvitationsSent]] = Field(None, description="Squad invitations sent list")
...
class SquadInvitationsReceivedList(BaseModel):
    list: Dict[str,List[SquadInvitationsReceived]] = Field(None, description="Squad invitations received list")
...
class Activity(BaseModel):
    ...
    speakers: Dict[str,List[Speaker]] = Field(None, description="Activity speaker list")
...
class JeecpotRewards(BaseModel):
    first_student_reward: Dict[str,Rewards] = Field(None, description="Jeecpot first student reward")
    first_student_winner: bool = Field(None, description="Jeecpot first student winner")
    second_student_reward: Dict[str,Rewards] = Field(None, description="Jeecpot second student reward")
    second_student_winner: bool = Field(None, description="Jeecpot second student winner")
    third_student_reward: Dict[str,Rewards] = Field(None, description="Jeecpot third student reward")
    third_student_winner: bool = Field(None, description="Jeecpot third student winner")
    first_squad_reward: Dict[str,Rewards] = Field(None, description="Jeecpot first student reward")
    first_squad_winner: bool = Field(None, description="Jeecpot first student winner")
    second_squad_reward: Dict[str,Rewards] = Field(None, description="Jeecpot second student reward")
    second_squad_winner: bool = Field(None, description="Jeecpot second student winner")
    third_squad_reward: Dict[str,Rewards] = Field(None, description="Jeecpot third student reward")
    third_squad_winner: bool = Field(None, description="Jeecpot third student winner")
    king_job_fair_reward: Dict[str,Rewards] = Field(None, description="Jeecpot first student reward")
    king_job_fair_winner: bool = Field(None, description="Jeecpot first student winner")
    king_knowledge_reward: Dict[str,Rewards] = Field(None, description="Jeecpot first student reward")
    king_knowledge_winner: bool = Field(None, description="Jeecpot first student winner")
    king_hacking_reward: Dict[str,Rewards] = Field(None, description="Jeecpot first student reward")
    king_hacking_winner: bool = Field(None, description="Jeecpot first student winner")
    king_networking_reward: Dict[str,Rewards] = Field(None, description="Jeecpot first student reward")
    king_networking_winner: bool = Field(None, description="Jeecpot first student winner")
