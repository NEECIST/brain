...
class JeecpotRewards(BaseModel):
    ...
    first_squad_reward: Dict[str,Rewards] = Field(None, description="Jeecpot first squad reward")
    first_squad_winner: bool = Field(None, description="Jeecpot first squad winner")
    second_squad_reward: Dict[str,Rewards] = Field(None, description="Jeecpot second squad reward")
    second_squad_winner: bool = Field(None, description="Jeecpot second squad winner")
    third_squad_reward: Dict[str,Rewards] = Field(None, description="Jeecpot third squad reward")
    third_squad_winner: bool = Field(None, description="Jeecpot third squad winner")
    king_job_fair_reward: Dict[str,Rewards] = Field(None, description="Jeecpot King of job fair reward")
    king_job_fair_winner: bool = Field(None, description="Jeecpot King of job fair winner")
    king_knowledge_reward: Dict[str,Rewards] = Field(None, description="Jeecpot King of knowledge reward")
    king_knowledge_winner: bool = Field(None, description="Jeecpot King of knowledge winner")
    king_hacking_reward: Dict[str,Rewards] = Field(None, description="Jeecpot King of hacking reward")
    king_hacking_winner: bool = Field(None, description="Jeecpot King of hacking winner")
    king_networking_reward: Dict[str,Rewards] = Field(None, description="Jeecpot King of networking reward")
